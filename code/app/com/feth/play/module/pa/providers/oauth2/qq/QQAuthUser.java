...
public class QQAuthUser extends BasicOAuth2AuthUser implements
	...
	public QQAuthUser(final JsonNode n, final QQAuthInfo info,
			final String state) {
	...
	public String getProvider() {
		return QQAuthProvider.PROVIDER_KEY;
	}
